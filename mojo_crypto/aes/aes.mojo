...
struct Aes[KeySize: Int]:
    ...
    def encrypt(
        self, input: InlineArray[UInt8, BLOCK_SIZE]
    ) -> InlineArray[UInt8, BLOCK_SIZE]:
        return cpu_cipher[Nr=Self.Nr](input, self.w)
...
comptime Aes128 = AesGpu[16]
comptime Aes192 = AesGpu[24]
comptime Aes256 = AesGpu[32]
...
struct AesGpu[KeySize: Int]:
    ...
    def encrypt(
        ...
        with DeviceContext() as ctx:
            ...
            block_in.enqueue_copy_from(input)
