...
from mojo_crypto.block_ciphers.aes import Aes128Naive
...
def test_ctr_32_le_aes() raises:
    ...
    comptime CTR = CtrMode[Aes128Naive, 4, BIG_ENDIAN=False]
...
def test_ctr_32_be_aes() raises:
    ...
    comptime CTR = CtrMode[Aes128Naive, 4, BIG_ENDIAN=True]
