...
from mojo_crypto.universal_hashes.ghash.cpu import mulx
...
def test_mulx_rfc8452_vector() raises:
    hex = Hex()
    input = hex.decode[BLOCK_SIZE]("9c98c04df9387ded828175a92ba652d8")
    expected = hex.decode[BLOCK_SIZE]("3931819bf271fada0503eb52574ca572")
...
def test_fe_mulx() raises:
    ...
    r = hex.decode[BLOCK_SIZE]("01000000000000000000000000000000")
